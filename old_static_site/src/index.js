    ...
    input.addEventListener('click', (event) => {
        const results = Array.from(
            document.querySelectorAll(
                '.implementation-metrics input:first-of-type'
            )
        );
        const sum = results
...
tippy('.tippy-phases', {
    content: `
            ...
            <p><strong>Phase 1:<br/> Maximum social-distancing measures are in place</strong> and tailored to the needs of the community to reduce widespread community transmission.  Focus is on reducing person-to-person transmission and decreasing the burden on the healthcare system while bolstering preparedness capabilities in anticipation of potential future increases in transmission. </p>
            <p><strong>Phase 2:<br/> Initial re-opening phase</strong> should focus on safely re-opening a limited number of critically important activities that are either low risk, or for which the criticality of the activity merits accepting a moderate degree of transmission risk (with appropriate mitigation).  In general, this phase should continue to prohibit gatherings, activities than entail prolonged close contact, and/or prolonged presence in enclosed spaces. Outdoor activities are potentially feasible with appropriate distancing. Telework should continue wherever feasible.</p>
            <p><strong>Phase 3:<br/> Economic recovery phase</strong> should focus on widely re-opening economic and social functions once ambient transmission has declined and is being effectively suppressed. Low levels of community transmission means that functions involving moderate gatherings are possible with appropriate mitigation. Large gatherings continue to pose an excessive risk. However, activities that entail prolonged contact or presence in enclosed spaces are feasible with appropriate mitigation.</p>
            <p><strong>Phase 4:<br/> New normal phase</strong> represents the maximal return to normalcy that is viable prior to herd immunity via widespread vaccination. Community transmission is well monitored and negligible; virus flare-ups are contained rapidly. Most high-risk/low criticality functions can resume.</p>
