...
const phaseContent = {
  phase_1: (
    <p>
      ...
      transmission. Focus is on reducing person-to-person transmission and
      decreasing the burden on the healthcare system while bolstering
      preparedness capabilities in anticipation of potential future increases in
      transmission.
    </p>
  ),
  phase_2: (
  ...
  phase_3: (
    <p>
      ...
      ambient transmission has declined and is being effectively suppressed. Low
      levels of community transmission means that functions involving moderate
  ...
  phase_4: (
    <p>
      ...
      immunity via widespread vaccination. Community transmission is well
      monitored and negligible; virus flare-ups are contained rapidly. Most
      high-risk/low criticality functions can resume.
    </p>
  ),
}
